...
if __name__ == "__main__":
    ...
    # Define publishers
    pos_pub = rospy.Publisher('/uav/position', Vector3, queue_size=10)
    vel_pub = rospy.Publisher('/uav/velocity', Twist, queue_size=10)
    yaw_pub = rospy.Publisher('/uav/yaw', Float64, queue_size=10)
    yaw_rate_pub = rospy.Publisher('/uav/yaw_rate', Float64, queue_size=10)
    ...
    rospy.Subscriber('/vicon/ts1/ts1', TransformStamped, vicon_callback)
